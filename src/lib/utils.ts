import * as B64js from "https://denopkg.com/chiefbiiko/base64/mod.ts";
...
export function b64UrlToBuffer(b64UrlString: string): Uint8Array {
  return new Uint8Array(B64js.toUint8Array(b64UrlDecode(b64UrlString)));
}

export function bufferTob64(buffer: Uint8Array): string {
  return B64js.fromUint8Array(new Uint8Array(buffer));
}
